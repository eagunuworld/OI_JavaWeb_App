...
pipeline {
  //agent any
   agent{
     ...
     parameters {
          choice choices: ['main','mss-prod', 'mss-warmart-prod', 'owasp_zap_scanning', 'slack_success_failed_demo', 'lab_mutation_Test', 'walmart-dev-mss', 'dependencyCheckTrivyOpenContest'], description: 'This is choice paramerized job', name: 'BranchName'
